...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> registerUser(@RequestBody User user) {
        ...
        try {
            ...
            return ResponseEntity.ok(Collections.singletonMap("user", registeredUser));
    ...
    @PostMapping("/login")
    public ResponseEntity<Map<String, Object>> authenticateUser(@RequestBody LoginRequest loginRequest, HttpSession session) {
        try {
